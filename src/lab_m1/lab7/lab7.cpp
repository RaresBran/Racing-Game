...
{
    {
        ...
        RenderSimpleMesh(meshes["sphere"], shaders["LabShader"], modelMatrix, glm::vec3(1, 0.45f, 1));
    }
    ...
    // Render the point light in the scene
    {
        ...
        RenderSimpleMesh(meshes["sphere"], shaders["Simple"], modelMatrix, glm::vec3(0, 0.5, 1));
    }
}
