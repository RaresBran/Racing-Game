...
void Lab3::Update(float deltaTimeSeconds)
{
    ...
    modelMatrix = modelMatrix + transform2D::Translate(translateX, translateY) *
    ...
    modelMatrix = modelMatrix + transform2D::Translate(translateX, -translateY) *
                                transform2D::Rotate(4 * angularStep) *
                                transform2D::Scale(2 * scaleX, scaleY);
    ...
    modelMatrix = modelMatrix + transform2D::Translate(-translateX, translateY) *
                                ...
                                transform2D::Scale(scaleX, 2 * scaleY);
